"""
Django settings for poma project.
...
class DEV(Configuration):
    ...
    WSGI_APPLICATION = "poma.wsgi.application"
    ...
    EMAIL_VERIFIED_CALLBACK = verified_callback
    EMAIL_FROM_ADDRESS = "noreply@pomasearch.com"
    EMAIL_MAIL_SUBJECT = "Verify your Poma account"
    ...
    EMAIL_MAIL_TOKEN_LIFE = 60 * 60
    EMAIL_MAIL_PAGE_TEMPLATE = "confirm_template.html"
    EMAIL_SUBJECT = "Verify your Poma account"
    EMAIL_HTML = "mail_body.html"
    EMAIL_PLAIN = "mail_body.txt"
    EMAIL_TOKEN_LIFE = 60 * 60
    EMAIL_PAGE_TEMPLATE = "confirm_template.html"
    EMAIL_PAGE_DOMAIN = "https://app.pomasearch.com/"
...
class PROD(DEV):
    ...
    AWS_STORAGE_BUCKET_NAME = "poma"
    AWS_S3_ACCESS_KEY_ID = os.getenv("AWS_ACCESS_KEY_ID")
    AWS_S3_SECRET_ACCESS_KEY = os.getenv("AWS_SECRET_ACCESS_KEY")
    AWS_S3_ENDPOINT_URL = "https://poma.s3.fr-par.scw.cloud"
    AWS_S3_REGION_NAME = "fr-par"

    STATIC_URL = AWS_S3_ENDPOINT_URL + "/poma/"
